...
export const amenities = [
  ...
  {
    title: "Long Term Staycation",
    icon: "/amenities/longterm.svg",
    type: "image",
  },
  ...
  return (
    <main className="font-bodyFont">
      <section className="hero-section relative z-10 flex flex-col items-center bg-hero-bg bg-cover bg-center min-h-[90vh] pt-[150px] pb-[320px]">
        ...
        <h1 className="font-headingFont text-3xl text-center z-30 text-llcream md:text-5xl absolute bottom-[400px]">
          An intimate stay crafted by passionate travellers.
        </h1>

        <div className="w-[50px] h-[50px] absolute z-10 bottom-[215px]">
          <ExportedImage alt="logo" width={100} height={100} src="/logo.svg" />
        </div>
      ...
      <section className="about-us px-5  py-10 sm:py-14 xl:py-20">
        <div className="grid gap-y-10 md:gap-10 xl:gap-x-20 md:grid-cols-3 max-w-screen-xl m-auto">
          <h1 className="text-4xl sm:mr-[10%] md:col-span-2 md:text-7xl font-headingFont">
            Welcome to the most <i className="text-llbeige">authentic</i> home,
            where exquisite <i className="text-llbeige">craftsmanship</i> meets
            the quality of
            <i className="text-llbeige"> your life</i>{" "}
          </h1>
          ...
          <h3 className="sm:mr-[10%] md:col-span-2 md:max-w-[400px] md:ml-auto font-bodyFont">
            We are the only property management company based in Penang,
            Malaysia that focuses on luxurious interior designs and intimate
            experiences to provide unparalleled comfort for your close friends
            and loved ones.{" "}
          </h3>

          <h3 className="font-bodyFont">
            Double L Villa, inspired by our founder&apos;s global travels and
            hospitality experiences, is crafted to provide the perfect
            staycation with a focus on creating memorable, intimate moments. Her
            passion for exceptional hospitality shines through in every detail,
            ensuring a stay that feels both indulgent and personal, making it a
            truly unique retreat.
          </h3>
        </div>
      </section>
      ...
      <section
        id="villas"
        className="villa-slider-section  bg-gradient-to-b from-white to-llcream py-10 md:py-14 xl:py-20"
      >
        <div className="max-w-screen-xl m-auto px-5">
          <h1 className="text-5xl md:text-6xl font-headingFont mb-5">
            Our Villas
          </h1>
          <VillaSlider />
        </div>
      ...
      <section className="px-5 py-10 md:py-14 xl:py-20">
        <div className="sm:flex gap-10 max-w-screen-xl m-auto">
          <div className="basis-1/2 flex flex-col justify-center gap-8 mb-5">
            <h1 className="text-5xl md:text-6xl font-headingFont">
              Exclusive Services
            </h1>
            <h4 className=" text-llblack font-bodyFont">
              Double L Villa offers exclusive services designed to perfect every
            ...
            <div className="grid grid-cols-4 gap-5">
              {amenities.map((amenity) => (
                <div
                  key={amenity.title}
                  className="font-headingFont text-center"
                >
                  <ExportedImage
                    className="m-auto mb-5 w-[40px] h-[40px]"
                    alt={amenity.icon}
                    width={100}
                    height={100}
                    src={amenity.icon}
          ...
          <ExportedImage
            className="basis-1/2 max-h-[600px] object-cover"
            alt="high-quality-soap"
            width={600}
            height={600}
        ...
        <div className="max-w-screen-xl m-auto">
          <div className="border-solid border-[1px] gap-5 border-black flex justify-center rounded-full items-center mb-5 m-auto w-fit py-1 px-8">
            ...
            <h3 className="font-headingFont sm:text-2xl">
              Hear Our Guests Experience
            </h3>
          </div>

          <h1 className="font-headingFont text-2xl mb-5 max-w-screen-lg m-auto md:text-5xl text-center italic">
            “The host is very responsive. The house is beautifully designed,
            built and decorated. The quality of furnitures, and amenities are
            all top notch. Is a good location for a gathering. I would give a
            score of 9/10 for this stay.”
          </h1>

          <h1 className="font-headingFont text-3xl xl:text-5xl text-center italic">
            -Wilson
          </h1>
        </div>
